...
int main(int argc, char **argv)
{
    ...
    nh.param<std::string>("server",serverName, "164.90.243.252");
    nh.param<std::string>("port",serverPort, "2101");
    nh.param<std::string>("username",userName, "u59639");
    nh.param<std::string>("password",password, "944nbn");
    nh.param<std::string>("serialPort",serialPort, "/dev/ttyS1");
    ...
    ROS_INFO("Dsername= %s",args.user); 
    ROS_INFO("Serial= %s",args.serdevice);
